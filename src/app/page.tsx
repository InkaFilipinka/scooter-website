      ...
      <section className="bg-white">
        ...
        <div className="container mx-auto px-4 py-12 md:py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            {/* Subheadline */}
            <p className="text-lg md:text-xl font-bold bg-gradient-to-r from-teal-600 via-emerald-600 to-teal-700 dark:from-teal-400 dark:via-emerald-400 dark:to-teal-500 bg-clip-text text-transparent mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-150">
              {t('hero.subheadline')}
            </p>
            {/* Content cards */}
