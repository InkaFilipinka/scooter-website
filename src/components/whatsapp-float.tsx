...
export function WhatsAppFloat() {
  return (
    <a
      href={WHATSAPP_URL}
      onClick={handleClick}
      className="fixed bottom-6 right-6 z-50 bg-green-700 hover:bg-green-800 text-white rounded-full p-4 shadow-2xl transition-all transform hover:scale-110 flex items-center gap-3 group"
    ...
    >
      ...
      <span className="hidden md:block font-semibold whitespace-nowrap pr-1">
        Chat with us
      </span>
    </a>
  );
